...
export default function QRCodeDisplay() {
  ...
  const registerUrl = buildTenantAwareUrl('/Register');
  ...
  function handleDownload() {
    ...
    link.download = 'qrcode-cadastro-morador.png';
  ...
  return (
    <div className="flex flex-col items-center gap-4 py-4">
      ...
      <p className="text-xs text-muted-foreground text-center px-2">
        Compartilhe este QR Code com os moradores para que eles possam solicitar o cadastro.
      </p>
